...
# %% Input
file_data = "/home/565/fl2086/Australian-synoptic-weather-types/reassignment_analysis/data_interactive_transition_matrix_tropics.nc"
...
plt.title("Synoptic weather types original \u2192 tropics only transition matrix",color=title_color,fontsize=18)
